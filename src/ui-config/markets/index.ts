...
export const marketsData: { [key in keyof typeof CustomMarket]: MarketDataType } = {
  [CustomMarket.proto_waterfall]: {
    ...
    aTokenPrefix: 'W',
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER: '0xAadB55a2fb49278312e9704078b7dc3958d9B652'.toLowerCase(),
      LENDING_POOL: '0x1f32eCf961D6c1cA78235715B6AD11ffb8d149cB',
      WETH_GATEWAY: '0x08E02E184A2C33eCa3F9C835a96e103486DcEBf2',
    },
  },
