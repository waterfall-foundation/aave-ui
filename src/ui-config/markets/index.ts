...
export const marketsData: { [key in keyof typeof CustomMarket]: MarketDataType } = {
  ...
  //   aTokenPrefix: 'A',
  //   addresses: {
  //     LENDING_POOL_ADDRESS_PROVIDER: '0x000e0fb30937B01b71BBE89dB27d6B2Ec73f2b11'.toLowerCase(),
  //     LENDING_POOL: '0x64B18E4ad57E442A98501f9bA7efbE1CFa64f00e',
  //     WETH_GATEWAY: '0x5CfcB031dFe8edDd80F6EDAc92A476F22a740BBd',
  //   },
  // },
